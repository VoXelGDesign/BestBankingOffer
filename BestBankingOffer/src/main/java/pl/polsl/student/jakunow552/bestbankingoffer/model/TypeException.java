...
/**
 * User exception class - extends {@link RuntimeException}.<p>
 * If exception is thrown, objects to compare have different types.<p>
 * Program do not allow to comapare different types of offers objects because they have different properties.
 * @version 1.0-FINAL
